					...
					<div class="well well-sm">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<p>
										<i>Para buscar o código da hospedagem, digite o CPF do
											Cliente</i>
									</p>
									<!-- Formulário pesquisa hospedagem -->
									...
									<!-- Fim Formulário pesquisa hospedagem -->
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<form id="consumo" class="form-horizontal"
										...
										<p>
											<i>Para registrar o consumo, digite o seu Código de
												Funcionário</i>
										</p>
										<label for="cod_func"><strong>Código do
												Funcionário:</strong></label> <input id="cod-func" name="cod-func"
											type="text" placeholder="Digite o seu Código de Funcionário"
